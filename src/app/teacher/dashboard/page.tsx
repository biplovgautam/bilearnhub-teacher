        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Ready to inspire minds today, {user?.displayName || user?.email || 'Educator'}?
            </p>
          </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Start creating courses to see student progress and activity here.
                  </p>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700">
                <div className="text-center space-y-4">
                  <LottiePlayer
                    {...animationPresets.dashboard.teacher}
                    className="mx-auto"
                    fallback={
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      Every lesson you create has the power to change a life. Keep teaching, keep inspiring!
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
                ...
                <p className="text-blue-100 text-sm mb-4">
                  See how your students experience your courses
                </p>
                <Link href="/">
