...
export default function StudentLogin() {
  ...
  const handleGoogleSignIn = async () => {
    setLoading(true);
    const { user, error } = await signInWithGoogle('student');
              ...
              <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-gray-600 dark:text-gray-400">
                    {isSignUp 
                      ? 'Start your learning journey with unlimited possibilities'
                    ...
                    <div className="w-full h-80 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 rounded-2xl flex items-center justify-center">
                      <div className="text-center space-y-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 font-medium">
                          {isSignUp ? 'Learning Excellence' : 'Welcome Back'}
                        </p>
                      </div>
                    </div>
                  }
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                      Student Portal - {isSignUp ? 'Create Account' : 'Sign In'}
                    </h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      ...
                      disabled={loading}
                    >
                      {loading ? 'Please wait...' : (isSignUp ? 'Start Learning' : 'Sign In')}
                    </Button>
                  </form>
